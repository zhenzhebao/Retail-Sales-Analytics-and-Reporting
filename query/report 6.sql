...
coalesce(cast(round(cast(avg(e.salary) as numeric),2) as char),'N/A') as "Average Salary of Direct Reports",
coalesce(cast(min(e.salary) as char),'N/A') as "Lowest salary of direct reports",
coalesce(cast(max(e.salary) as char),'N/A') as "Highest salary of direct reports"
from employees e

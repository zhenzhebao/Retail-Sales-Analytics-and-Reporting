...
from clean_info),
invoice_data as(
select p.unit_price,ip.quantity,i.invoiceno,i.invoicedate,STRFTIME('%Y-%m',i.invoicedate) as year_month,
i.customer_id
from product p
...
round(total_revenue*1.0/nullif(invoice_count,0),2) as avg_invoice_value
